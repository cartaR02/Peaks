...
import Exercise from "./exerciseName";
      ...
      case "search":
        return (
          <Search
            ...
            switchToExercise={createExerciseScreen}
          />
        );
      case "workout":
        return (
          <Exercise navigation={navigation} sentExerciseData={currentScreen} />
        );
      default:
        return (
          <Search
